  ...
  <div class="inner">
    ...
    <div class="presenter-grid">
      ...
      <div>
        ...
        <p class="presenter-bio">30 years in enterprise technology. 14 professional certifications including GitLab ×9 and GitHub ×4. 40+ enterprise clients and £20m+ in programme budgets delivered. Currently writing <em>Spec Driven Development: AI-Native Software Engineering</em> — the book that formalises the methodology this talk introduces. Published author of <em>AI Immigrants</em>. Remote-first. Budapest · Dublin · London.</p>
